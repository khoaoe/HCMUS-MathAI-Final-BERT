...
% =======================================================================
\subsection{Cấu hình Thực nghiệm Chi tiết}
\label{subsec:experiment_config}

\subsubsection{Thông số Kiến trúc Mô hình}
...
Random seed & 42 & 42 \\
Reproducibility & torch.manual\_seed(42) & torch.manual\_seed(42)\\
\bottomrule
\end{tabular}
\end{table}
...
\subsubsection{Cấu hình Hardware}
...
% =======================================================================
\subsection{Kết quả Thực nghiệm Mở rộng}
\label{subsec:extended_results}

\subsubsection{Chi tiết kết quả}
...
\midrule
TF-IDF + LR & 0.854 & 0.855 & 0.855 & 0.855 & 2 minutes \\
BERT Fine-tuned & \textbf{0.895} & \textbf{0.90} & \textbf{0.895} & \textbf{0.895} & 6 minutes \\
\midrule
\textbf{Improvement} & \textbf{+4.1\%} & \textbf{+4.5\%} & \textbf{+4.0\%} & \textbf{+4.0\%} & - \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\multirow{2}{*}{TF-IDF + LR} & Negative & 0.87 & 0.84 & 0.85 & 500 \\
& Positive & 0.84 & 0.87 & 0.86 & 500 \\
\midrule
\multirow{2}{*}{BERT Fine-tuned} & Negative & 0.92 & 0.87 & 0.89 & 500 \\
...
\midrule
\multirow{2}{*}{\rotatebox{90}{\textbf{Actual}}} & \textbf{Negative} & 442 & 64 \\
& \textbf{Positive} & 41 & 453 \\
\bottomrule
\end{tabular}
\end{table}
...
& & \textbf{Negative} & \textbf{Positive} \\
\midrule
\multirow{2}{*}{\rotatebox{90}{\textbf{Actual}}} & \textbf{Negative} & 420 & 86 \\
& \textbf{Positive} & 60 & 434 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
1 & 0.5277 & 0.3066 & 0.8850 \\
2 & 0.3116 & 0.3005 & 0.8950 \\
3 & 0.2375 & 0.4706 & 0.8940 \\
\bottomrule
\end{tabular}
\end{table}
...
\subsubsection{Các thành phần của BERT}
...
\paragraph{Độ phức tạp} self-attention:
\begin{align}
...
\subsubsection{Tổng quan IMDb dataset}
...
\subsubsection{t-SNE cho embeddings}
...
\paragraph{Link video thuyết trình (Youtube):} \href{https://youtu.be/sOHMstidMQg}{youtu.be/sOHMstidMQg}

\paragraph{Link Google Colab của thực nghiệm:} \href{https://colab.research.google.com/drive/1LeZfdr22j_FC_qEG92QfVIE6dz_ppF6g?usp=sharing}{colab.research.google.com}

\paragraph{Link source code (GitHub):} \href{https://github.com/khoaoe/HCMUS-MathAI-Final-BERT}{github.com/khoaoe/HCMUS-MathAI-Final-BERT}
